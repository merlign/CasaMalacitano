        ...
        <div className="relative bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-4 sm:p-6 lg:p-8 flex flex-col md:flex-row gap-6 items-center justify-between border border-gray-100">
          ...
          <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 mt-2 md:mt-0">
            <div className="flex items-center gap-4 group cursor-pointer">
              <div className="p-3 bg-gray-50 rounded-full group-hover:bg-casa-teal/10 transition-colors text-casa-teal">
                <Calendar size={24} />
              </div>
              <div>
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="relative">
            <img 
              ...
              className="rounded-2xl shadow-2xl object-cover h-[300px] md:h-[500px] w-full"
            />
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-lg group hover:shadow-xl transition-all flex flex-col">
              <div className="h-64 overflow-hidden relative">
                <img 
                  src="/casita.jpg" 
                  alt="Casita Malacitano" 
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full text-xs font-bold text-casa-text uppercase tracking-wide">
                  Detached
                </div>
              </div>
              <div className="p-8 flex flex-col flex-1">
                <h3 className="text-2xl font-serif mb-3">Casita Malacitano</h3>
                <p className="text-casa-text-light mb-8 line-clamp-3 flex-1">
                  A beautiful, stylishly furnished detached house with its own veranda. Equipped with a spacious living room with open kitchen, bedroom and a modern bathroom. Enjoy the breathtaking view in complete privacy.
                </p>
                <div className="flex items-center gap-4">
                  <a href="#" className="bg-casa-teal hover:bg-casa-teal/90 text-white px-6 py-3 rounded-full font-medium transition-colors">
                    Book now
                  </a>
                  <a href="https://www.airbnb.nl/rooms/947665014354184314" target="_blank" rel="noreferrer" className="text-casa-text-light hover:text-casa-teal underline underline-offset-4 text-sm font-medium transition-colors">
                    or view on Airbnb
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-lg group hover:shadow-xl transition-all flex flex-col">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-casa-text-light mb-8 line-clamp-3 flex-1">
                  A cozy and beautifully renovated studio apartment. Connected to the main building, but with a private entrance and terrace. Perfect as a comfortable base for hikers and active travelers.
                </p>
                <div className="flex items-center gap-4">
                  <a href="#" className="bg-casa-teal hover:bg-casa-teal/90 text-white px-6 py-3 rounded-full font-medium transition-colors">
                    Book now
                  </a>
                  <a href="https://www.airbnb.nl/rooms/711527784364828762" target="_blank" rel="noreferrer" className="text-casa-text-light hover:text-casa-teal underline underline-offset-4 text-sm font-medium transition-colors">
                    or view on Airbnb
                  </a>
                </div>
              </div>
