    ...
    <div className="min-h-screen bg-casa-stone font-sans text-casa-text">
      ...
      <main className="pt-24 md:pt-28">
        ...
        <ReviewsSection
          ...
          className="pt-16 md:pt-24 pb-16 md:pb-24 px-4 md:px-8 max-w-7xl mx-auto"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 mt-16 md:mt-24">
          <a href="/casita" className="group flex flex-col sm:flex-row items-center gap-6 bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-all">
            <img src={homepage.accommodations.casita.image} alt={homepage.accommodations.casita.title} className="w-full sm:w-40 h-32 rounded-2xl object-cover shrink-0" />
            <div className="flex-1 text-center sm:text-left">
              <p className="text-xs font-bold uppercase tracking-widest text-casa-teal mb-1">Looking for something else?</p>
              <h2 className="text-xl font-serif text-casa-text group-hover:text-casa-teal transition-colors">{homepage.accommodations.casita.title}</h2>
              <p className="text-sm text-casa-text-light mt-1">{homepage.accommodations.casita.badge}. See availability and photos.</p>
            </div>
          </a>
        </div>
