...
import {
  ...
  ChevronRight, Mail, ArrowLeft, Key, Thermometer,
} from 'lucide-react'
      ...
      <main className="pt-24 md:pt-28">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 mt-10">
          <div className="bg-casa-teal rounded-3xl px-8 md:px-12 py-8 md:py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <a
              href="mailto:info@casamalacitano.com?subject=Booking request – Casita Malacitano"
          ...
          <div className="space-y-14">
            ...
            <section>
              ...
              <div className="space-y-4 text-casa-text-light leading-relaxed">
                ...
                <p className="text-sm bg-casa-stone-dark rounded-2xl p-4 text-casa-text-light">The casita can only be reached by car. The village centre is a 5-minute walk away.</p>
              </div>
            </section>
                ...
                <div className="flex flex-wrap gap-4">
                  {NOT_AVAILABLE.map((item) => (
                    <span key={item} className="flex items-center gap-1.5 text-sm text-gray-400 line-through decoration-gray-300">
                      <X size={12} className="text-gray-300 shrink-0 no-underline" style={{ textDecoration: 'none' }} />
                      {item}
                    </span>
                  ))}
                </div>
